...
\*======================================================================*/
    ...
    {  
        ...
        if(!extension_loaded('curl'))
        {
            ...
            foreach($result_headers as $currentHeader => $resultHeader)
            {
                if(is_array($resultHeader)) continue;
                ...
                if(preg_match("|^HTTP/|i",$result_headers[$currentHeader]))
        ...
        else
        {
            ...
            if(!empty($result_headers['redirect_url']))$this->_redirectaddr = $result_headers['redirect_url'];
            if(!empty($result_headers['request_header'])) $this->headers = $result_headers['request_header'];
        }
