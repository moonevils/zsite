...
$config->cache->cachedPages = 'index.index,article.browse,product.browse,product.view,page.view,blog.view,book.browse,book.index,book.read,';
...
$config->cache->relation[TABLE_ARTICLE]['pages']  = 'article.browse,blog.index,blog.view';
...
$config->cache->relation[TABLE_CATEGORY]['pages']  = 'article.browse,blog.index,blog.view,product.browse,index.index';
...
$config->cache->relation[TABLE_FILE]['pages']  = 'article.browse,blog.index,blog.view,product.browse,product.view,index.index,blog.index,';
