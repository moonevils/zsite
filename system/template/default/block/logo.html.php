{*php*}
$logoSetting = isset($lang->site->logo) ? json_decode($lang->site->logo) : new stdclass();
$logo = false;
...
{else}
<div class='site-name' data-ve='block' data-id='{!echo $block->id}'><h2 data-ve='logo'>{!echo html::a($lang->webRoot, $lang->site->name)}</h2></div>
{/if}
