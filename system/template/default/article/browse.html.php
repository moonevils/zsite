        ...
        <div class='item' id="article{$article->id}" data-ve='article'>
          ...
          <div class='item-heading'>
            <div class="text-muted pull-right">
              <span title="{!echo $config->viewsPlaceholder . $article->id . $config->viewsPlaceholder}">
                <i class='icon-eye-open'></i>
                {!echo $config->viewsPlaceholder . $article->id . $config->viewsPlaceholder}
              </span> &nbsp;
              {if(commonModel::isAvailable('message') and $article->comments)}
                <span title="{!echo $lang->article->comments}"><i class='icon-comments-alt'></i> {!echo $article->comments}</span> &nbsp;
              {/if}
