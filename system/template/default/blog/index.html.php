...
{if(!empty($category))}
  {!echo $common->printPositionBar($category, '', '', $root);}
{/if}
    ...
    <div id='blogList'>
          ...
          <div class="card" data-ve='blog' id='blog{!echo $stick->id}'>
            ...
            <div class="card-actions text-muted">
              ...
              {if(commonModel::isAvailable('message') and isset($stick->comments) and $stick->comments)}
                &nbsp; <a href="{!echo $url . '#commentForm'}"><span data-toggle='tooltip' title='{!printf($lang->article->lblComments, $stick->comments)}'><i class="icon-comments-alt"></i> {!echo $stick->comments}</span></a>
              {/if}
      ...
      {if(!isset($category))} {$category = array_shift($article->categories)} {/if}
        ...
        <div class="card" data-ve='blog' id='blog{!echo $article->id}'>
          ...
          <div class='card-content text-muted'> {!echo $article->summary} </div>
          <div class="card-actions text-muted">
            ...
            {if(commonModel::isAvailable('message') and $article->comments)}
              &nbsp; <a href="{!echo $url . '#commentForm'}"><span data-toggle='tooltip' title='{!printf($lang->article->lblComments, $article->comments)}'><i class="icon-comments-alt"></i> {!echo $article->comments}</span></a>
            {/if}
