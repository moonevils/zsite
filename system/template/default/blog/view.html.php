    ...
    <div class='article' id='blog' data-id='{!echo $article->id}'>
      <header>
        ...
        <dl class='dl-inline'>
          ...
          {if($article->source == 'article') $article->copyURL = commonModel::getSysURL() . $control->article->createPreviewLink($article->copyURL)}
...
{if(strpos($article->content, '<embed ') !== false) include TPL_ROOT . 'common/jplayer.html.php'}
