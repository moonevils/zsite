  ...
  <tbody>
    ...
    <tr class='text-middle'>
      ...
      <td>
        ...
        if($file->isImage)
        {
            echo html::a(inlink('download', "id=$file->id"), html::image($this->loadModel('file')->printFileURL($file->pathname, $file->extension, $file->objectType, 'smallURL'), "class='image-small' title='{$file->title}'"), "target='_blank'");
