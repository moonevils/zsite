...
{*php*}
              ...
              echo html::a($url, html::image($control->loadModel('file')->printFileURL($page->image->primary->pathname, $page->image->primary->extension, '', 'smallURL'), "title='{$title}' class='thumbnail'" ));
{*/php*}
            </div>
            {/if}
