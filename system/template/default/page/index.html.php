            ...
            <div class='item-content'>
              {if(!empty($page->image))}
                <div class='media pull-right'>
                  ...
                  {!html::a($url, html::image($control->loadModel('file')->printFileURL($page->image->primary->pathname, $page->image->primary->extension, '', 'smallURL'), "title='$title' class='thumbnail'" ))}
                </div>
              {/if}
