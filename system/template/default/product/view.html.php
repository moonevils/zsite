      ...
      <div class='row'>
        ...
        <div class='col-sm-5' id='productImageWrapper'>
          <div class='product-image media-wrapper' id='productImage'>
            ...
            {!echo html::image("{{$config->webRoot}}file.php?pathname={{$product->image->primary->pathname}}&objectType=product&imageSize=&extension={{$product->image->primary->extension}}", "title='$title' alt='$product->name'")}
            ...
            <div class='product-image-menu clearfix' id='imageMenu'>
              ...
              <div class="product-image-wrapper">
                <div class='product-image little-image'>
                  {!echo html::image("{{$config->webRoot}}file.php?pathname={{$image->pathname}}&objectType=product&imageSize=&extension={{$image->extension}}", "title='{{$title}}' alt='{{$product->name}}'")}
                </div>
              </div>
              {/foreach}
            </div>
