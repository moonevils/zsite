...
{*php*}
              ...
              echo html::a($object->url, html::image($control->loadModel('file')->printFileURL($object->image->primary->pathname, $object->image->primary->extension, $object->objectType, 'smallURL'), "title='{$title}' class='thumbnail'" ));
{*/php*}
            </div>
            {/if}
