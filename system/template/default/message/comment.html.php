  ...
  <div class='comment-container'>
    ...
    <div class='w-p100 panel comment-item comment-panel' id="comment{$comment->id?>">
      <div class='panel-heading content-heading'>
        ...
        {!echo html::a($control->createLink('message', 'reply', "commentID=$comment->id"), "<i class='icon icon-reply text-info'> </i>", "class='pull-right' data-toggle='modal' data-type='iframe' data-icon='reply' data-title='{{$lang->comment->reply}}'")}
      </div>
      ...
      {/if}
       <div class='form-group'>
        <div class='col-sm-11 col-sm-offset-1'>
          <span>{!echo html::submitButton('', 'btn btn-primary', 'data-popover-container="false"')}</span>
