  ...
  <div class='comment-container'>
    ...
    <div class='w-p100 panel comment-item comment-panel' id="comment<?php echo $comment->id?>">
      <div class='panel-heading content-heading'>
        <span class='text-special'><?php echo $comment->from;?></span>
        <span class='text-muted'> <?php echo $comment->date;?></span>
        <?php echo html::a($this->createLink('message', 'reply', "commentID=$comment->id"), $lang->message->reply, "class='pull-right' data-toggle='modal' data-type='iframe' data-icon='reply' data-title='{$lang->comment->reply}'");?>
      </div>
