    ...
    <form method='post' class='form-horizontal' id='threadForm' enctype='multipart/form-data'>
      <div class='form-group'>
        ...
        <div class='col-md-11 col-sm-10'>
          ...
          <div class='input-group'>
            {!echo html::input($titleInput, '', "class='form-control'")}
            <div class='input-group-addon colorplate clearfix'>
              <div class='input-group color active' data=''>
                ...
                {!echo html::input('color', '', "class='form-control input-color text-latin' placeholder='" . $lang->colorTip . "'")}
      ...
      <div class='threadInfo'>
        <div class='form-group'>
          ...
          <div class='col-md-11 col-sm-10'>{!echo html::textarea($contentInput, '', "rows='15' class='form-control'")}</div>
        </div>
      ...
      <div class='form-group link'>
        ...
        <div class='col-md-11 col-sm-10 required'>{!echo html::input('link', '', "class='form-control' placeholder='{$lang->thread->placeholder->link}'")}</div>
      </div>
      {/if}
      <div class='form-group'>
        ...
        <div class='col-md-11 col-sm-10'>{!echo html::submitButton()}</div>
      </div>
    </form>
  </div>
</div>
