<div class='panel thread'>
  <div class='panel-heading'>
    ...
    <div class='panel-actions'>
      {if($thread->readonly) echo "<span class='label'><i class='icon-lock'></i> " . $lang->thread->readonly . "</span> &nbsp;"}
    </div>
  ...
  <div class='thread-foot'>
    ...
    <div class='pull-right thread-actions'>
      {if($control->app->user->account != 'guest')}
        ...
        {/if}
      {if($control->thread->canManage($board->id, $thread->author)) echo html::a(inlink('edit', "threadID=$thread->id"), '<i class="icon-pencil"></i> ' . $lang->edit)}
