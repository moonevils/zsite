...
<header class='appbar fix-top' id='appbar'>
  <div class='appbar-title'>
    <a href='{!echo $model->config->webRoot}' id='logo'>
  ...
  <div class='appbar-actions'>
      ...
      <div class='dropdown-menu fade search-bar' id='searchbar'>
        <form action='{!echo helper::createLink('search')}' method='get' role='search'>
          <div class='input-group'>
            ...
            {!echo html::input('words', $keywords, "class='form-model' placeholder=''")}
    ...
    {if(commonModel::isAvailable('shop'))}
      <a class='btn with-badge' href='{!echo helper::createLink('cart', 'browse')}'><i class='icon icon-shopping-cart'></i><strong class='cart-count badge small text-danger circle hide'>12</strong></a>
    {/if}
    ...
    <div class='dropdown'>
      ...
      <ul class='dropdown-menu dropdown-menu-right' id='topbarBox'>{!echo $model->config->siteNavHolder}</ul>
    </div>
    {/if}
  </div>
</header>
