    ...
    <div class='card'>
      ...
      <div class='table-layout'>
        ...
        if(!empty($article->image))
        {
            ...
            $thumbnailLink = html::a($url, html::image("{$this->config->webRoot}file.php?pathname={$article->image->primary->pathname}&objectType=article&imageSize={$imageURL}&extension={$article->image->primary->extension}", "title='{$thumbnailTitle}' class='thumbnail'" ));
