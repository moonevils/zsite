    ...
    <div class='card'>
      ...
      <div class='table-layout'>
        ...
        if(!empty($article->image))
        {
            ...
            $thumbnailLink = html::a($url, html::image("{$this->config->webRoot}file.php?f={$article->image->primary->pathname}&s={$imageURL}&t={$article->image->primary->extension}&v={$this->config->site->lastUpload}", "title='{$thumbnailTitle}' class='thumbnail'" ));
