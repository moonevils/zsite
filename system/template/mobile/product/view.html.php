...
<div class='footer-left'>
    {!html::a(helper::createLink('cart', 'browse', 'source=product'), html::image('/theme/mobile/product/cart.png') . "<span class='label badge red circle'>0</span>", "style='position:relative'")}
</div>
<div class='footer-left'>
