...
$lang->site->moduleAvailableGroups->user['user']    = '会员';
$lang->site->moduleAvailableGroups->user['forum']   = '论坛';
$lang->site->moduleAvailableGroups->user['message'] = '评论留言';
$lang->site->moduleAvailableGroups->user['search']  = '搜索';
                                 
$lang->site->moduleAvailableGroups->content = array();
$lang->site->moduleAvailableGroups->content['book']       = '手册';
$lang->site->moduleAvailableGroups->content['page']       = '单页';
$lang->site->moduleAvailableGroups->content['article']    = '文章';
$lang->site->moduleAvailableGroups->content['blog']       = '博客';
$lang->site->moduleAvailableGroups->content['submittion'] = '投稿';
                                 
$lang->site->moduleAvailableGroups->mall = array();
$lang->site->moduleAvailableGroups->mall['shop']    = '商城';
$lang->site->moduleAvailableGroups->mall['product'] = '产品';
                                 
$lang->site->moduleAvailableGroups->score = array();
$lang->site->moduleAvailableGroups->score['score'] = '积分';
$lang->site->moduleAvailableGroups->score['stat']  = '统计';
