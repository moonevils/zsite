...
if($config->multi)  $config->site->ui->customCssFile = $app->getDataRoot() . 'css/' . $config->site->code . '/%s/%s.css';
if(!$config->multi) $config->site->ui->customCssFile = $app->getDataRoot() . 'css/%s/%s.css';
