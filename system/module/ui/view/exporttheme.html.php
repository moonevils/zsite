...
<?php js::set('template', $this->config->template->{$this->app->clientDevice}->name);?>
<?php js::set('theme', $this->config->template->{$this->app->clientDevice}->theme);?>
    ...
    <tr>
      ...
      <td>
        ...
        <div class='input-group'>
          <?php echo html::select('template', $templateOptions, $this->config->template->{$this->app->clientDevice}->name, "class='form-control'");?>
