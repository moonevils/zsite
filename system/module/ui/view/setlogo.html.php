  ...
  <div class='panel-body row row-logo'>
    <form method='post' id='ajaxForm' enctype='multipart/form-data'>
      <div class='col-md-6'>
        <div class='box'>
          <div class='card'>
          <?php if(isset($logo->webPath)) echo html::a('javascript:;', html::image("/file.php?pathname={$logo->pathname}&objectType=logo&imageSize=&extension={$logo->extension}", "class='logo'"), "class='btn-upload'");?>
      ...
      <div class='col-md-6'>
        <div class='box'>
        <div class='card'>
          <?php if(isset($favicon->webPath)) echo html::a('javascript:;', html::image("/file.php?pathname={$favicon->pathname}&objectType=favicon&imageSize=&extension=ico", "class='favicon'"), "class='btn-upload'");?>
