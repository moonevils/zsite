...
$lang->ui->files->default->block['about']           = 'About Company';
$lang->ui->files->default->block['articletree']     = 'Article Categories';
$lang->ui->files->default->block['blogtree']        = 'Blog Categories';
...
$lang->ui->files->default->block['hotproduct']      = 'Hot Products';
$lang->ui->files->default->block['htmlcode']        = 'HTML Code';
$lang->ui->files->default->block['html']            = 'Custom';
$lang->ui->files->default->block['latestarticle']   = 'Latest Articles';
$lang->ui->files->default->block['latestblog']      = 'Latest Blogs';
$lang->ui->files->default->block['latestproduct']   = 'Latest Products';
$lang->ui->files->default->block['latestthread']    = 'Latest Threads';
...
$lang->ui->files->default->article['browse'] = 'Articels';
