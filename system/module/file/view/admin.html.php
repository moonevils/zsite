          ...
          <tr class='text-center text-middle'>
            ...
            <td class='text-center'>
              <?php 
                ...
                {
                  echo html::a(helper::createLink('file', 'download', "fileID=$file->id"), html::image("/file.php?pathname={$file->pathname}&objectType={$file->objectType}&imageSize=&extension={$file->extension}", "class='image-small'"), "target='_blank' data-toggle='lightbox'");
                }
                else
                {
