...
<tr>
  <th><?php echo $lang->block->category->initialExpand;?></th>
  <td><?php echo html::radio('params[initialExpand]', $lang->block->category->initialExpandList, isset($block->content->initialExpand) ? $block->content->initialExpand : 'no');?></td>
</tr>
<tr>
