...
$lang->score->getByThread = '論壇發表主題'; 
$lang->score->getByReply  = '論壇發表回帖'; 

$lang->score->lblTotal   = "共有消耗積分：%s, 等級積分：%s ";
$lang->score->lblNoScore = "抱歉，您的積分不夠";
$lang->score->lblNoScoreReason = "<p>抱歉，您的積分不夠。<strong>%s</strong> 需要 <strong class='red'>%s</strong>分，您現在有 <strong class='red'>%s</strong>分。</p>
                                  您可以通過以下方式增加您的積分。<br />";
$lang->score->lblDetail        = "詳情可參考<a href='http://www.chanzhi.net/thread-view-79915.html' target='_blank'>《如何獲得積分》</a><br /><br />";
