...
<form method='post' action='<?php echo helper::createLink('ui', 'setlogo');?>' class='ve-form mw-800px center-block' enctype='multipart/form-data'>
  <table class='table table-form'>
    ...
    <tr><td></td><td colspan='2'><?php if(isset($logo->webPath)) echo html::image("{$config->webRoot}file.php?pathname={$logo->pathname}&objectType=logo&imageSite=extension={$logo->extension}", "class='logo'");?></td></tr>
    <tr>
      <td></td>
      <td colspan='2'>
