...
$lang->visual->js->subRegion         = '子佈局區塊';
$lang->visual->js->randomRegion      = '隨機佈局區塊';
$lang->visual->js->subRegionDesc     = '可以包含其他區塊';
$lang->visual->js->randomRegionDesc  = '包含的區塊隨機顯示';
...
$lang->visual->setting->powerby['actions']['edit']         = array('title' => '移除蟬知標識', 'text' => '移除蟬知標識', 'alert' => $lang->visual->editPowerBy);
...
$lang->visual->setting->columns                            = array('name' => "分欄設置", 'actions' => array());
$lang->visual->setting->columns['actions']['edit']         = array('title' => "側邊欄設置", 'text' => "側邊欄設置");
