...
$lang->execInfo       = "<div id='execInfoBar' class='text-right'>SQL query : <b>%s</b> times, memory useage : <b>%s</b>, PHP executed time : <b>%s</b> seconds。 <button type='button' class='close text-danger' data-dismiss='alert' aria-hidden='true'>×</button> </div>";
