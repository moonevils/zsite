...
$lang->execInfo       = "<div id='execInfoBar' class='hide'><span class='text-left'>SQL query : <b>%s</b> times, memory useage : <b>%s</b>, PHP executed time : <b>%s</b> seconds。 <button type='button' class='close text-danger' data-dismiss='alert' aria-hidden='true'>×</button> </span></span>";
...
$lang->security->menu->captcha   = 'Captcha Setting|guarder|setcaptcha|';
...
$lang->k  = '蝉知建站系统，PHP开源免费的企业门户系统; ';
$lang->k .= '蝉知企业门户，开源免费的企业建站CMS系统; ';
$lang->k .= '蝉知CMS系统，更好用的企业建站系统; ';
$lang->k .= '蝉知商城系统，企业营销网站的首选; ';
$lang->k .= '蝉知企业建站系统，PHP开源免费的CMS系统;';
