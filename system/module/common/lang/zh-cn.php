...
$lang->execInfo       = "<div id='execInfoBar' class='text-right'>SQL查询：<b>%s</b> 次，内存占用：<b>%s</b> 字节， PHP 执行时间：<b>%s</b> 秒。 <button type='button' class='close text-danger' data-dismiss='alert' aria-hidden='true'>×</button> </div>";
