...
$lang->package->errorGetPackages             = '從www.chanzhi.org獲得插件失敗。可能是因為網絡方面的原因，您可以到 <a href="http://www.chanzhi.org/extension" target="_blank" class="alert-link">www.chanzhi.org</a> 手工下載插件，然後上傳安裝。';
