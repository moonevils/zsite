...
$lang->message->contactHidden  = "以下電話、手機、郵箱、qq聯繫方式只有網站管理員可見，不會暴露。";
...
$lang->comment->inputPlaceholder        = '添加你的評論';
...
$lang->comment->submit          = '發表評論';
$lang->comment->submitting      = '稍後';
