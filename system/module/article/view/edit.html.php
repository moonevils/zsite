        ...
        <td colspan='2'>
          <div class='order  input-group'>
            <span class='input-group-btn colorplate'>
              <span class='current color active' data='<?php echo $article->titleColor;?>'>
              ...
              <?php echo html::input('titleColor', $article->titleColor, "class='form-control input-color hidden' placeholder='" . $lang->colorTip . "'");?>
            </span>
