    ...
    <div class='card' data-ve='product' id='product<?php echo $product->id?>'>
      ...
      <div class='card-heading'>
        ...
        <div class='text-nowrap text-ellipsis'>
          ...
          <?php if($productView):?><span data-toggle='tooltip' class='text-muted views-count' title='<?php echo $lang->product->viewsCount;?>'><i class="icon icon-eye-open"></i> <?php echo $config->viewsPlaceholder . $product->id;?></span><?php endif;?>
        </div>
      </div>
    </div>
  </div>
