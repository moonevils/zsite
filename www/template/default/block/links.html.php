...
<div id="block<?php echo $block->id;?>" class='panel panel-block <?php echo $blockClass;?>'>
  ...
  <div class='panel-body'>
    <div id='links<?php echo $block->id;?>' data-ve='links'><?php $this->config->links = $this->loadModel('file')->revertRealSRC($this->config->links, 'index,all'); echo $this->config->links->index;?></div>
  </div>
</div>
<?php endif;?>
