...
<div id="block<?php echo $block->id;?>" class='panel panel-block <?php echo $blockClass;?>'>
  <div class='panel-body'>
    <div class='card'>
      <div class='media' style='background-image: url(<?php echo "/file.php?pathname={$product->image->primary->pathname}&objectType=product&imageSize=middleURL&extension={$product->image->primary->extension}";?>);'><?php echo html::image("/file.php?pathname={$product->image->primary->pathname}&objectType=product&imageSize=middleURL&extension={$product->image->primary->extension}", "title='{$product->name}' alt='{$product->name}'"); ?></div>
