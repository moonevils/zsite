  ...
  <tbody>
    ...
    <tr class='text-middle'>
      ...
      <td>
        ...
        if($file->isImage)
        {
            echo html::a(inlink('download', "id=$file->id"), html::image(helper::createLink('file', 'read', "fileID={$fileID}&type=smallURL", '', "{$file->extension}"), "class='image-small' title='{$file->title}'"), "target='_blank'");
