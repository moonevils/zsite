    ...
    <a class='card' href='<?php echo $url?>' id="article<?php echo $article->id?>" data-ve='article'>
      ...
      <div class='table-layout'>
        ...
        <?php
          ...
          echo html::image("{$config->webRoot}file.php?pathname={$article->image->primary->pathname}&objectType=article&imageSize=smallURL&extension={$article->image->primary->extension}", "title='{$title}' class='thumbnail'");
        ?>
        </div>
        <?php endif;?>
      </div>
