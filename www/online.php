...
<?php
  ...
  switch($action) 
  {
      ...
      case 'check-file':
          if(isset($result['md5']))
          {
              if(md5_file($downloadFile) == $result['md5'])
              {
                  echo json_encode(array('result' => 'success'));
              }
              else
      ...
      <div class='col-md-8 col-md-offset-2 main-body'>   
        ...
        <div class='box-body'>
          ...
          <div class='error-box'>
              ...
              <p>在网站服务器上创建文件<code><?php echo __DIR__ . '/' . $_SESSION['filename'] . '.txt';?></code>，并写入内容<code><?php echo $_SESSION['filecontent'];?></code></p>
              <?php elseif(!$config->envReady):?>
              <strong>修改文件夹写入权限</strong>
              <code >sudo chmod -R 777 <?php echo __DIR__;?></code>
              <?php endif;?>
          </div>
          <?php endif;?>
        </div>
